...
public class WaveSeven extends Wave {

    public WaveSeven(Map map) {
        super(map);
    }
    ...
    public List<EntityEnemy> getEnemyQueue(Map map) {
        ...
        for(int i = 0; i < 6; i++) {
            ...
            enemyQueue.add(new EntityEnemySeven(map, randomJourney.getStartType(), randomJourney.getEndType()));
        }
